...
extension UserModelQueryWhereSort
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhere> anyIdIsar() {
...
extension UserModelQueryWhere
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> idIsarEqualTo(
      Id idIsar) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> idIsarNotEqualTo(
      Id idIsar) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> idIsarGreaterThan(
      Id idIsar,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> idIsarLessThan(
      Id idIsar,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<UserModel, UserModel, QAfterWhereClause> idIsarBetween(
    Id lowerIdIsar,
    Id upperIdIsar, {
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> idIsarEqualTo(
      Id value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'idIsar',
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> idIsarGreaterThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> idIsarLessThan(
    Id value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition> idIsarBetween(
    Id lower,
    Id upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByIdIsar() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idIsar', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByIdIsarDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, int, QQueryOperations> idIsarProperty() {
    return QueryBuilder.apply(this, (query) {
